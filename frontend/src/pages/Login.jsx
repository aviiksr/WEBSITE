...
import { KeyRound, ShieldCheck, Mail, Lock, ArrowLeft } from 'lucide-react';
...
const Login = () => {
  ...
  useEffect(() => {
    ...
    setTimeLeft(300); // reset when OTP page shows up
        ...
        <AnimatePresence mode="wait">
          {!otpRequired ? (
            ...
            >
              ...
              <h2 className="text-3xl font-extrabold mb-2 text-center gradient-text">Welcome Back</h2>
              <p className="text-gray-400 text-sm text-center mb-6">Enter your details to sign in securely.</p>
              ...
              <form onSubmit={handlePasswordSubmit} className="space-y-4">
                ...
                <button 
                  type="submit" 
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-secondary)] hover:opacity-90 py-3 rounded-xl font-bold transition mt-6 flex items-center justify-center"
                >
                  {loading ? 'Securing Connection...' : 'Continue'}
                </button>
              </form>

              <p className="mt-6 text-center text-gray-400 text-sm">
                Don't have an account? <Link to="/register" className="text-indigo-400 hover:underline font-semibold">Register here</Link>
              </p>
            </motion.div>
          ) : (
            ...
            >
              ...
              <p className="text-gray-400 text-sm text-center mb-6">
                A 6-digit secure login verification OTP was sent to <strong className="text-gray-200">{email}</strong>.
              </p>
